      ...
      <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start mb-20">
          ...
          <div className="border border-border-custom bg-white p-8">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4 items-center bg-rose-gold/5 p-4 border border-rose-gold/20">
                ...
                <div>
                  <h4 className="font-sans text-xs font-bold tracking-wider uppercase text-rose-gold-dark">
                    Policy
                  </h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-sans text-xs font-bold tracking-wider uppercase text-charcoal mb-1">
                    Location
                  </h4>
        ...
        <div className="lg:col-span-7 flex flex-col gap-8 w-full">
          ...
          <div className="bg-white border border-border-custom p-8 md:p-10 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="font-display text-2xl md:text-3xl font-light text-charcoal mb-4 uppercase tracking-wider">
              Book on WhatsApp
            </h3>
          ...
          <div className="border border-border-custom bg-white p-8">
            <h3 className="font-display text-xl font-light text-charcoal mb-6 uppercase tracking-wider">
              Find Us on Map
            </h3>
